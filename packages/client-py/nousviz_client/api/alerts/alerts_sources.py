...
from ...models.alert_sources_response import AlertSourcesResponse
...
) -> AlertSourcesResponse | ErrorDetail | RBACErrorDetail | None:
    if response.status_code == 200:
        response_200 = AlertSourcesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AlertSourcesResponse | ErrorDetail | RBACErrorDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AlertSourcesResponse | ErrorDetail | RBACErrorDetail
    """
