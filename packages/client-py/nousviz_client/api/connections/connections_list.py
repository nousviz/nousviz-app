...
) -> ConnectionsListResponse | ErrorDetail | RBACErrorDetail | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ConnectionsListResponse | ErrorDetail | RBACErrorDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ConnectionsListResponse | ErrorDetail | RBACErrorDetail
    """
