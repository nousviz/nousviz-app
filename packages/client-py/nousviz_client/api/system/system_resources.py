...
) -> ErrorDetail | HTTPValidationError | RBACErrorDetail | ResourcesResponse | None:
    if response.status_code == 200:
        response_200 = ResourcesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDetail | HTTPValidationError | RBACErrorDetail | ResourcesResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorDetail | HTTPValidationError | RBACErrorDetail | ResourcesResponse
    """
