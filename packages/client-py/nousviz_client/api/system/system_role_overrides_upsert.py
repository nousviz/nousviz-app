...
from ...models.role_override_request import RoleOverrideRequest
from ...models.role_override_response import RoleOverrideResponse
...
) -> ErrorDetail | HTTPValidationError | RBACErrorDetail | RoleOverrideResponse | StepUpRequiredDetail | None:
    if response.status_code == 200:
        response_200 = RoleOverrideResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorDetail | HTTPValidationError | RBACErrorDetail | RoleOverrideResponse | StepUpRequiredDetail]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorDetail | HTTPValidationError | RBACErrorDetail | RoleOverrideResponse | StepUpRequiredDetail
    """
