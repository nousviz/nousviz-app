...
) -> DocResponse | ErrorDetail | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DocResponse | ErrorDetail | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DocResponse | ErrorDetail | HTTPValidationError
    """
