...
T = TypeVar("T", bound="SyncScheduleRegistry")


@_attrs_define
class SyncScheduleRegistry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_schedule_registry.additional_properties = d
        return sync_schedule_registry
