...
T = TypeVar("T", bound="JobAlertSubscriptionListResponse")


@_attrs_define
class JobAlertSubscriptionListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for subscriptions_item_data in _subscriptions:
            subscriptions_item = JobAlertSubscription.from_dict(subscriptions_item_data)

            subscriptions.append(subscriptions_item)

        job_alert_subscription_list_response = cls(
            subscriptions=subscriptions,
        )

        job_alert_subscription_list_response.additional_properties = d
        return job_alert_subscription_list_response
