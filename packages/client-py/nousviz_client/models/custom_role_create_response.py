...
T = TypeVar("T", bound="CustomRoleCreateResponse")


@_attrs_define
class CustomRoleCreateResponse:
    ...
    Attributes:
        ...
        permissions (list[str] | Unset): Sorted seed permission set after sensitive-permission filtering.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_role_create_response = cls(
            role=role,
            display_name=display_name,
            created_by=created_by,
        ...
        custom_role_create_response.additional_properties = d
        return custom_role_create_response
