...
T = TypeVar("T", bound="ConnectionsListResponse")
...
class ConnectionsListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for connections_item_data in _connections:
            connections_item = ConnectionRow.from_dict(connections_item_data)

            connections.append(connections_item)

        connections_list_response = cls(
            connections=connections,
        )

        connections_list_response.additional_properties = d
        return connections_list_response
